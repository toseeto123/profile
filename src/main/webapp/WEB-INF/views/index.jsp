...
<link rel="icon" type="image/x-icon"
	href="${pageContext.request.contextPath}/resources/static/assets/favicon.ico" />
...
<body>
	...
	<header class="py-5 bg-image-full"
		...
		<div class="text-center my-5">
			<h1 class="text-white fs-3 fw-bolder">DevMeet</h1>
			<p class="text-white-50 mb-0">개발자들의 커뮤니티</p>
		</div>
	</header>
	<!-- Content section-->
	<section class="py-5">
	...
	<section class="py-5">
		<div class="container my-5">
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<h2>팀 프로젝트 조회순으로 노출</h2>
					<p class="lead">1인가구를 위한 인테리어 결제 판매 웹 사이트 제작</p>
					<p class="mb-0">대표 스킬 : Spring,Java,JavaScript,MariaDB,Apache
						Tomcat,AWS</p>
				</div>
			</div>
		</div>
	...
	<section class="py-5">
		<div class="container my-5">
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<h2>개인 프로젝트 조회 순으로 노출</h2>
					<p class="lead">개인 포트폴리오 사이트</p>
	...
	<!-- Core theme JS-->
	<script
		src="${pageContext.request.contextPath}/resources/static/js/scripts.js"></script>
</body>
</html>
